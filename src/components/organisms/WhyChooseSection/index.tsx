...
const ContentCart = () => {
  return contentCartsWhyChooseSection.map((el, index) => (
    <div
      key={index}
      className="relative font-bold p-4 sm:min-h-[602px] md:min-h-[640px] lg:min-h-[700px] bg-white rounded-lg"
    >
      ...
      <div className="w-full bg-white rounded-2xl sm:mt-6 mt-6">
        ...
        <div className="flex my-4">
          <span className="text-sm md:text-[16px] lg:text-[18px] font-bold leading-5">
            {" "}
            {el.content}{" "}
          </span>
        </div>
